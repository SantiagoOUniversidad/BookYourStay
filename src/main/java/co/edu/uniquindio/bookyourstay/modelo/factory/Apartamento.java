...
public class Apartamento extends Alojamiento {
    ...
    public Apartamento(TipoAlojamiento alojamiento, String nombre, String ciudad, String descripcion, ImageView imagen, float precioPorNoche, int capacidadMaxima, List<TipoServicio> servicios, float costoExtra) {
